...
| Measure | Done | Total | % |
| --- | ---: | ---: | ---: |
| **Unique strings translated (all)** | **123,817** | **461,704** | **26.82%** |
| ↳ original corpus (Phases 0–17) | 92,000 | 429,887 | 21.40% |
| ↳ game-update strings (Update-N) | 31,817 | 31,817 | 100.00% |
| **In-game text coverage** — `translate_words_map_en` entries (`strings.jsonl`) | **530,547** | **826,388** | **64.20%** |
...
| 17 | 400,000–429,886 | **active** | 401,000 | 1,000 / 29,887 | 3.35% |
