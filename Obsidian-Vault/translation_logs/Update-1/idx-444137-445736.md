# Update-1 — Batch 9 — idx 444,137–445,736
...
- This batch was thick with long personal-letter and diary lore rather
  ...
  one of the longest single entries seen in Update-1 so far). All
...
- Homestead facility names in square brackets (`[Stove]`, `[Dining
  ...
  convention (e.g. `[Interlocking Joint]` locked earlier in Update-1).
