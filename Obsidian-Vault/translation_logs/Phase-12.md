# Phase 12 Translation Log (idx 250,000–251,999)
...
Phase 12 currently holds a single starter batch, committed 2026-09-25
(`147c8b7` — "Start Phase 12 translation (idx 250000-251999, 2000 rows)").
`locale/phase12.jsonl` has 2,000 rows; the phase is **not complete** — see
